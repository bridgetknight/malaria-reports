...
if __name__ == '__main__':
    ...
    parser.add_argument("--fraction_aligned_bases", help="number of bases aligned out of all bases in the sequence", required=True) # check
    ...
    print(str(qscorey)+' '+str(type(qscorey)))
