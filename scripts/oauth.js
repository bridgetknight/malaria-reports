...
function oauthSignIn() {
    ...
    var params = {'client_id': '602335226495-psmg90rl7i66pctfokhf77odr92n335d.apps.googleusercontent.com',
                  'redirect_uri': 'http://localhost:5500/analysis.html',
                  'response_type': 'token',
                  'scope': 'https://www.googleapis.com/auth/devstorage.read_only https://www.googleapis.com/auth/cloud-platform.read-only',
...
function parseURL() {
    ...
    console.log(splitURL.get("access_token"));
    return splitURL;
}
...
function toggleText() {
    ...
    var success = localStorage.getItem("igvSuccess");
    if(success === true) {
